  ...
  .vue-waterfall-easy-scroll(ref="scrollEl")
    ...
    .vue-waterfall-easy(
      ...
      .img-box(
        ...
        a.img-inner-box(:data-index="i", :href="v[hrefKey]", target="_blank")
          slot(name="img-header", :value="v")
          a.img-wraper(
            v-if="v[srcKey]",
...
<script>
//https://github.com/lfyfly/vue-waterfall-easy  基于pug模板，适配vue3
